...
- [Azure Active Directory](/docs/self-hosted/guides/azure-active-directory)
- [GitLab](/docs/self-hosted/guides/gitlab)
...
When using `byo` you'll need to [configure your registry](/docs/self-hosted/administration/configuration/#registry) to use a persistent volume for storage. 
