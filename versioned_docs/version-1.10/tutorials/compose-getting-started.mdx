...
- Configure Access to your Okteto Namespace [using the Okteto CLI](cloud/credentials.mdx#download-your-kubernetes-credentials-using-the-okteto-cli) or [using the Okteto dashboard](cloud/credentials.mdx#download-your-kubernetes-credentials-from-the-okteto-cloud-ui).
